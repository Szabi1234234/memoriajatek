...
while (kitoltve < 16) {
    ...
    if( kepek [i1][j1] == "" && kepek[i2][j2] == "" ){
        ...
        document.getElementById("k"+i1+j1).firstChild.src = "img/" + fajlnevek[r];
        document.getElementById("k"+i2+j2).firstChild.src = "img/" + fajlnevek[r];
...
function lepes(kartya){
    ...
    if (kartya.firstChild.stlye.display == "inline"){
        kartya.firstChild.style.display = "none";
    }
};